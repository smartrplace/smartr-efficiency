...
@Component
public class ScheduleViewerConfigProvHWI extends DefaultScheduleViewerConfigurationProviderExtended {
	public static final String PROVIDER_ID = "OfflineEvaluationControlHWI";
	...
	public static DefaultScheduleViewerConfigurationProviderExtended getInstance() {
		if(instance == null) instance = new ScheduleViewerConfigProvHWI();
		return instance;
	}

	protected static volatile ScheduleViewerConfigProvHWI instance = null;
	@Override
	...
	protected void setInstance(DefaultScheduleViewerConfigurationProviderExtended instanceIn) {
		instance = (ScheduleViewerConfigProvHWI) instanceIn;
	}
