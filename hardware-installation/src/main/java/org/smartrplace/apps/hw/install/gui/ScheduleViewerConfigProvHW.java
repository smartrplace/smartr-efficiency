...
@Component
public class ScheduleViewerConfigProvHW extends DefaultScheduleViewerConfigurationProviderExtended {
	public static final String PROVIDER_ID = "OfflineEvaluationControlHW";
	...
	public static DefaultScheduleViewerConfigurationProviderExtended getInstance() {
		if(instance == null) instance = new ScheduleViewerConfigProvHW();
		return instance;
	}

	protected static volatile ScheduleViewerConfigProvHW instance = null;
	@Override
	...
	protected void setInstance(DefaultScheduleViewerConfigurationProviderExtended instanceIn) {
		instance = (ScheduleViewerConfigProvHW) instanceIn;
	}
