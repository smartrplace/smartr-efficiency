...
@Component
public class ScheduleViewerConfigProvAlarmExp extends DefaultScheduleViewerConfigurationProviderExtended {
	public static final String PROVIDER_ID = "OfflineEvaluationControlAlarmExp";
	...
	public static DefaultScheduleViewerConfigurationProviderExtended getInstance() {
		if(instance == null) instance = new ScheduleViewerConfigProvAlarmExp();
		return instance;
	}

	protected static volatile ScheduleViewerConfigProvAlarmExp instance = null;
	@Override
	...
	protected void setInstance(DefaultScheduleViewerConfigurationProviderExtended instanceIn) {
		instance = (ScheduleViewerConfigProvAlarmExp) instanceIn;
	}
