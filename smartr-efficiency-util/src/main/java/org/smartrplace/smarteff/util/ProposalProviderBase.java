...
public abstract class ProposalProviderBase<T extends SmartEffResource>  implements ProposalProvider {
	...
	@Override
	public String id() {
		return ProposalProviderBase.this.getClass().getName();
	}
	...
	public ProposalProviderBase(ApplicationManagerSPExt appManExt) {
		...
		resultTypeDeclaration = new ExtensionResourceTypeDeclaration<SmartEffResource>() {
			...
			public String label(OgemaLocale locale) {
				return ProposalProviderBase.this.label(locale)+" Result";
			}
		...
		if(paramType != null) {
			...
			if(paramTypeDeclaration == null) {
				paramTypeDeclaration = new ExtensionResourceTypeDeclaration<SmartEffResource>() {
					...
					@Override
					public String label(OgemaLocale locale) {
						return ProposalProviderBase.this.label(locale)+" Parameters";
					}
