...
public class HardwareInstallAppSuperadmin implements Application, HWInstallExtensionProvider {
	...
	GenericControllerReceiver<HardwareInstallController> controllerRecv =
		...
		protected void controllerAndAppmanAvailable(HardwareInstallController controller,
			...
			ThermostatPage thAutoPage = new ThermostatPage(thermPageAuto, controller, ThermostatPageType.AUTO_MODE);
			menu.addEntry(thAutoPage.getHeader(), thermPageAuto);
			...
			ThermostatPage thValvePage = new ThermostatPage(thermPageValve, controller, ThermostatPageType.VALVE_ONLY);
			...
			WidgetPage<?> thermPageLock = widgetApp.createWidgetPage("thermostatLock.hmtl");
			ThermostatPage thLockPage = new ThermostatPage(thermPageLock, controller, ThermostatPageType.LOCKING);
			menu.addEntry(thLockPage.getHeader(), thermPageLock);
			thermPageLock.getMenuConfiguration().setCustomNavigation(menu);
			...
			menu.addEntry(thbatPage.getHeader(), thermPageBatWindow);
			...
			DeviceHandlerPage dhpage = new DeviceHandlerPage(devHandPage, true, controller);
