...
@Component
public class ScheduleViewerConfigProvAlarm extends DefaultScheduleViewerConfigurationProviderExtended {
	public static final String PROVIDER_ID = "OfflineEvaluationControlAlarm";
	...
	public static DefaultScheduleViewerConfigurationProviderExtended getInstance() {
		if(instance == null) instance = new ScheduleViewerConfigProvAlarm();
		return instance;
	}

	protected static volatile ScheduleViewerConfigProvAlarm instance = null;
	@Override
	...
	protected void setInstance(DefaultScheduleViewerConfigurationProviderExtended instanceIn) {
		instance = (ScheduleViewerConfigProvAlarm) instanceIn;
	}
